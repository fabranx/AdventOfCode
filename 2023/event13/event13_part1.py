...
def horizzontal_reflection(pattern):
    reflection_row = 0
...
if __name__ == '__main__':
    ...
    for pattern in pattern_list:
        v_row = horizzontal_reflection(pattern)
        v_col = vertical_reflection(pattern)
        # part1_solutions.append((v_row, v_col))
        count += v_col + (v_row*100)

    print(count)
    # print(part1_solutions)
